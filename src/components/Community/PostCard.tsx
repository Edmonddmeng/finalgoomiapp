...
//   const displayCommentCount = showComments ? comments.length : (post.commentCount || post.comments?.length || 0)
...
//     } else {
//       await pinPostMutation.mutateAsync(post.id)
//     }
//     window.location.reload() // Simple refresh for now
//   }
...
//     if (post.isLocked) {
//       await unlockPostMutation.mutateAsync(post.id)
//     } else {
//       await lockPostMutation.mutateAsync(post.id)
//     }
//     window.location.reload() // Simple refresh for now
//   }
...
//                     onClick={() => {
//                       setShowEditForm(false)
//                       setEditPost({ title: post.title, content: post.content, tags: post.tags || [] })
//                     }}
...
//             {!showEditForm && post.photoUrl && !imageError && (
...
//             {!showEditForm && post.tags && post.tags.length > 0 && (
