...
//                   disabled={updating === 'general'}
//                   className={`w-10 h-10 rounded-full ${color.class} ring-2 ring-offset-2 transition-all disabled:opacity-50 ${
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700">
        <div className="space-y-2">
          ...
          {/* Help & Support with expandable content */}
          <div>
            {/* Toggle Button */}
            <button
              onClick={() => setShowHelpExpanded(!showHelpExpanded)}
              className="w-full flex items-center justify-between py-3 px-3 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-lg transition-colors"
            >
              <div className="flex items-center gap-3">
                <HelpCircle className="text-gray-600 dark:text-gray-400" size={20} />
                <span className="font-medium text-gray-900 dark:text-white">Help & Support</span>
              ...
              <ChevronDown 
                className={`transform transition-transform duration-300 ${
                  showHelpExpanded ? 'rotate-180' : 'rotate-0'
                }`} 
                size={20} 
              />
            </button>

            {/* Contact Details with Smooth Animation */}
            <div 
              className={`ml-8 mr-3 overflow-hidden transition-all duration-300 ease-in-out ${
                showHelpExpanded 
            ...
            >
              <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-lg border border-gray-200 dark:border-slate-600">
                <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Contact Us</h4>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <MapPin className="text-red-600 dark:text-red-400 mt-0.5" size={16} />
                    <div>
